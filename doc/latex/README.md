...
Pour obtenir au plus vite une démonstration fonctionnelle, nous avons optimisé la deuxième représentation avec une énumération efficace des cas possibles. Cependant par manque de temps, nous n'avons pas pu pousser l'optimisation, contrairement à nos prédécesseurs [^theyhadtime]. En particulier avec la mise en place de _bitboards_, qui augmentent de manière significative les performances, mais aurait nécessiter beaucoup de temps pour le déployer sur le web.
