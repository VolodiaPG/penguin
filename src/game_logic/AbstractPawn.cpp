...
{
    _owner->_moves_done.push({(AbstractBoardCell*)_current_cell, (AbstractBoardCell *)cell, (AbstractPawn<game::AbstractPlayer, game::AbstractBoardCell> *)this});
    _current_cell = cell;
}
...
template class game::AbstractPawn<AbstractPlayer, AbstractBoardCell>;
